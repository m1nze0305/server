...
gdjs.MansionEscapeCode.userFunc0x9f35f8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.MansionEscapeCode.userFunc0x9f3670 = function GDJSInlineCode(runtimeScene) {
"use strict";
const player = runtimeScene.getObjects("Player")[0];
...
gdjs.MansionEscapeCode.userFunc0x9eed08 = function GDJSInlineCode(runtimeScene) {
"use strict";
const player = runtimeScene.getObjects("Player")[0];
if (!player) {
  return;
...
gdjs.MansionEscapeCode.userFunc0x9f35f8(runtimeScene);
...
gdjs.MansionEscapeCode.userFunc0x9f3670(runtimeScene);
...
gdjs.MansionEscapeCode.userFunc0x9eed08(runtimeScene);
...
{gdjs.evtTools.network.sendAsyncRequest("https://myserver.onrender.com/hiscore?name=Player&clearTime=" + gdjs.evtTools.common.toString(gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSeconds(runtimeScene, "gametime")), "", "GET", "", gdjs.VariablesContainer.badVariable, gdjs.VariablesContainer.badVariable);
}
{gdjs.evtTools.runtimeScene.pauseTimer(runtimeScene, "gametime");
}
{for(var i = 0, len = gdjs.MansionEscapeCode.GDPlayerObjects1.length ;i < len;++i) {
...
if (isConditionTrue_0) {
{gdjs.evtTools.window.openURL("https://myserver.onrender.com/rank", runtimeScene);
}
}
